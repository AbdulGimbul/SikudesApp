...
import kotlinx.android.synthetic.main.fragment_klas_petani.*
 ...
 * Use the [KlasPetaniFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class KlasPetaniFragment : Fragment(), CrudView {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_klas_petani, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment KlasPetaniFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KlasPetaniFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        klasifikasiPekerjaan.getKerjaTani()
    }
    ...
    override fun onSuccessGet(data: List<DataItem>?) {
        rv_pendudukPetani.adapter = DataKlasifikasiAdapter(data)
    }
