...
import kotlinx.android.synthetic.main.fragment_klas_goldar_a.*
 ...
 * Use the [KlasGoldarAFragment.newInstance] factory method to
 * create an instance of this fragment.
 */

class KlasGoldarAFragment : Fragment(), CrudView {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_klas_goldar_a, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment KlasGoldarAFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KlasGoldarAFragment().apply {
    ...
    override fun onSuccessGet(data: List<DataItem>?) {
        rv_pendudukA.adapter = DataKlasifikasiAdapter(data)
    }
