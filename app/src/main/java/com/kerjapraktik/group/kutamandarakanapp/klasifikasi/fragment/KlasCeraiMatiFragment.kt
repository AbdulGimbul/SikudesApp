...
import com.kerjapraktik.group.kutamandarakanapp.presenter.KlasifikasiStatus
import kotlinx.android.synthetic.main.fragment_klas_cerai_mati.*
 ...
 * Use the [KlasCeraiMatiFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class KlasCeraiMatiFragment : Fragment(), CrudView {

    private lateinit var klasifikasiStatus: KlasifikasiStatus
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_klas_cerai_mati, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment KlasCeraiMatiFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KlasCeraiMatiFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        klasifikasiStatus = KlasifikasiStatus(this)

        klasifikasiStatus.getStatusCeraiMati()
    }
    ...
    override fun onSuccessGet(data: List<DataItem>?) {
        rv_pendudukCeraiMati.adapter = DataKlasifikasiAdapter(data)
    }
