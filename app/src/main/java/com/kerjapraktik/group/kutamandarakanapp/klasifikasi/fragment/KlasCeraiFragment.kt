...
import kotlinx.android.synthetic.main.fragment_klas_cerai.*
 ...
 * Use the [KlasCeraiFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class KlasCeraiFragment : Fragment(), CrudView {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_klas_cerai, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment KlasCeraiFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KlasCeraiFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        klasifikasiStatus.getStatusCerai()
    }
    ...
    override fun onSuccessGet(data: List<DataItem>?) {
        rv_pendudukCerai.adapter = DataKlasifikasiAdapter(data)
    }
