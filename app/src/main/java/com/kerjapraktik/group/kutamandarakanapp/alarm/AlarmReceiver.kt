package com.kerjapraktik.group.kutamandarakanapp.alarm
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val TYPE_ONE_TIME = "Pengingat Agenda"
        const val TYPE_REPEATING = "Pengingat Agenda Rutin"
    ...
    fun setOneTimeAlarm(context: Context, type: String, date: String, time: String, message: String){
        ...
        Toast.makeText(context, "Alarm pengingat diterapkan", Toast.LENGTH_SHORT).show()
    }
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String){
        ...
        Toast.makeText(context, "Pengingat agenda rutin diterapkan", Toast.LENGTH_SHORT).show()
    }
    ...
    fun cancelAlarm(context: Context, type: String){
        ...
        Toast.makeText(context, "Pengingat agenda rutin dibatalkan", Toast.LENGTH_SHORT).show()
    }
}
