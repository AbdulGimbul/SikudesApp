...
class AlarmActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    companion object{
        ...
        private const val TIME_PICKER_ONCE_TAG = "TimePickerOnceTag"
        private const val TIME_PICKER_REPEAT_TAG = "TimePickerRepeatTag"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_one_time.setOnClickListener(this)
