...
import kotlinx.android.synthetic.main.fragment_klas_guru.*
 ...
 * Use the [KlasGuruFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class KlasGuruFragment : Fragment(), CrudView {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_klas_guru, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment KlasGuruFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KlasGuruFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        klasifikasiPekerjaan.getKerjaGuru()
    }
    ...
    override fun onSuccessGet(data: List<DataItem>?) {
        rv_pendudukGuru.adapter = DataKlasifikasiAdapter(data)
    }
