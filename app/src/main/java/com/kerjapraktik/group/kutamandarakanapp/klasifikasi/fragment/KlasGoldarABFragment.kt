...
import kotlinx.android.synthetic.main.fragment_klas_goldar_a_b.*
 ...
 * Use the [KlasGoldarABFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class KlasGoldarABFragment : Fragment(), CrudView {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_klas_goldar_a_b, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment KlasGoldarABFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KlasGoldarABFragment().apply {
    ...
    override fun onSuccessGet(data: List<DataItem>?) {
        rv_pendudukAB.adapter = DataKlasifikasiAdapter(data)
    }
