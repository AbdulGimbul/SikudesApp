...
import kotlinx.android.synthetic.main.fragment_klas_pns.*
 ...
 * Use the [KlasPnsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class KlasPnsFragment : Fragment(), CrudView {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_klas_pns, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment KlasPnsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KlasPnsFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        klasifikasiPekerjaan.getKerjaPNS()
    }
    ...
    override fun onSuccessGet(data: List<DataItem>?) {
        rv_pendudukPns.adapter = DataKlasifikasiAdapter(data)
    }
