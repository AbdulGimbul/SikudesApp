...
import kotlinx.android.synthetic.main.fragment_klas_menikah.*
 ...
 * Use the [KlasMenikahFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class KlasMenikahFragment : Fragment(), CrudView {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_klas_menikah, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment KlasMenikahFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KlasMenikahFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        klasifikasiStatus.getStatusMenikah()
    }
    ...
    override fun onSuccessGet(data: List<DataItem>?) {
        rv_pendudukMenikah.adapter = DataKlasifikasiAdapter(data)
    }
