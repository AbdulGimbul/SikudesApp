...
import kotlinx.android.synthetic.main.fragment_klas_goldar_b.*
 ...
 * Use the [KlasGoldarBFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class KlasGoldarBFragment : Fragment(), CrudView {

    private lateinit var klasifiikasiGoldar: KlasifikasiGoldar
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_klas_goldar_b, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment KlasGoldarBFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KlasGoldarBFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        klasifiikasiGoldar = KlasifikasiGoldar(this)

        klasifiikasiGoldar.getGoldarB()
    }
    ...
    override fun onSuccessGet(data: List<DataItem>?) {
        rv_pendudukB.adapter = DataKlasifikasiAdapter(data)
    }
