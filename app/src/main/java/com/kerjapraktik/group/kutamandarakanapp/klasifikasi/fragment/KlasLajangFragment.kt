...
import kotlinx.android.synthetic.main.fragment_klas_lajang.*
 ...
 * Use the [KlasLajangFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class KlasLajangFragment : Fragment(), CrudView {

    private lateinit var klasikasiStatus: KlasifikasiStatus
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_klas_lajang, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment KlasLajangFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KlasLajangFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        klasikasiStatus = KlasifikasiStatus(this)

        klasikasiStatus.getStatusLajang()
    }
    ...
    override fun onSuccessGet(data: List<DataItem>?) {
        rv_pendudukLajang.adapter = DataKlasifikasiAdapter(data)
    }
